...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* ─── TOP BAR ─── */}
      <div className="relative z-10 flex items-center justify-between px-4 pt-3 pb-1 flex-shrink-0 safe-top">
        <div>
      ...
      {/* ─── TAB BAR ─── */}
      <div className="relative z-10 flex items-center gap-1 px-4 pb-1 flex-shrink-0">
        {([
                ...
                <div className="text-center flex-shrink-0" style={{ minHeight: 48 }}>
                  {isIdle && (
                    <div className="animate-fade-in">
                      <h2 className="font-display text-white text-xl font-semibold leading-tight">
                  ...
                  {(isSessionActive || isCountdown) && (
                    <div className="animate-fade-in">
                      <div
                        className="font-mono-nums text-2xl font-medium"
                      ...
                      <div className="flex items-center gap-2 justify-center mt-1">
                        <div className="h-0.5 rounded-full overflow-hidden" style={{ width: 100, background: 'rgba(255,255,255,0.08)' }}>
                          <div
                ...
                <div className="text-center flex-shrink-0" style={{ minHeight: 40 }}>
                  {isSessionActive && breathingState.currentPhase && (
                    <div className="animate-fade-in" key={breathingState.currentPhaseIndex}>
                      <p className="phase-label text-white/75 text-base" style={{ textShadow: `0 0 16px ${accentGlow}` }}>
          ...
          {!isSessionActive && !isCountdown && !isComplete && (
            <div className="relative z-10 flex-shrink-0 pb-2 safe-bottom">
              ...
              <div className="px-4 mt-1.5">
                ...
                {showProtocolDetail && (
                  <div className="mt-2 glass-card p-3 animate-fade-in-up max-h-44 overflow-y-auto">
